package sheetsManagement.components.commands.chat.chatarea;
...
import sheetsManagement.components.commands.chat.chatarea.model.ChatLinesWithVersion;
        ...
        HttpClientUtil.runAsync(finalUrl, new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    ChatLinesWithVersion chatLinesWithVersion = new Gson().fromJson(rawBody, ChatLinesWithVersion.class);
